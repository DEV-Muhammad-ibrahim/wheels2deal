...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/projects-car-rental-reservations.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:44:05 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="projects-car-rental-reservations.html"><span>Reservations</span></a></li>
									...
									<div class="p5 px-4">
										<div class="row mb5">
											...
											<div class="col-12">
												...
												<input type="text" class="form-control" id="form-element-2" placeholder="Customer Name">
											</div>
										</div>
										<div class="row">
											<div class="col-6">
									...
									<table class="table qd-table mb6 align-middle">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<span class="badge rounded-pill badge-soft text-bg-success">Accepted</span>
												</td>
												<td>
													<strong>$45,00</strong>
												</td>
											...
											<tr>
												...
												<td>
													<span class="badge rounded-pill badge-soft text-bg-danger">Canceled</span>
												</td>
												<td>
													<strong>$70,25</strong>
												</td>
