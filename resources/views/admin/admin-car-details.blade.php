                ...
                <ul class="menu-group m-0 px-4 mb-4">
                    <li class="sub-menu active">
                        ...
                        <ul class="sub-menu-group">
                            ...
                            <li class="active"><a href="projects-car-rental-car-details.html"><span>Car
                                        Details</span></a></li>
                                ...
                                <ul class="top-menu-group">
                                    ...
                                    <li class="top-sub-menu">
                                        ...
                                        <div class="top-level-menu-wrapper">
                                            <ul class="top-sub-menu-group">
                                                ...
                                                <li><a class="d-flex align-items-center justify-content-between"
                                                        href="apps-inbox-view-reply.html"><span>View &
                                                            Reply</span></a></li>
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li class="top-sub-menu">
                                        ...
                                        <div class="top-level-menu-wrapper">
                                            <ul class="top-sub-menu-group">
                                                ...
                                                <li><a class="d-flex align-items-center justify-content-between"
                                                        href="apps-tasks-task-detail.html"><span>Task
                                                            Detail</span></a></li>
                                                <li><a class="d-flex align-items-center justify-content-between"
                                    ...
                                    <li class="top-sub-menu">
                                        ...
                                        <div class="top-level-menu-wrapper">
                                            <ul class="top-sub-menu-group">
                                                <li><a class="d-flex align-items-center justify-content-between"
                                                        href="apps-file-manager-files.html"><span>Files</span></a>
                                                </li>
                                                <li><a class="d-flex align-items-center justify-content-between"
