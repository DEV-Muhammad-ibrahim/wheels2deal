...
<div id="main-wrapper">
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-6 text-right font-12"> <a href="index.html">Admin</a> &gt; View Shipments</div>
                <div class="">
                    <button
                                ...
                                <table id="example23" class="display nowrap table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="#"
                                                    class="btn waves-effect waves-light btn-rounded close-bt">Delivered</a>
                                            </td>
                                            <td>Mason vox</td>
                                            <td>1/1/2018</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>uam est qui </td>
                                            <td><a href="#"
                                                    class="btn waves-effect waves-light btn-rounded open-bt">Shipped</a>
                                            </td>
                                            <td>Neque porro quisq</td>
                                            <td>15/2/2018</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>consectetur</td>
                                            <td><a href="#"
                                                    class="btn waves-effect waves-light btn-rounded close-bt">Shipped</a>
                                            </td>
                                            <td>Jonathan Max</td>
                                            <td>5/5/2018</td>
                                            <td class="text-center">DHL</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>dolor sit amet</td>
                                            <td><a href="#"
                                                    class="btn waves-effect waves-light btn-rounded close-bt">Pending
                                                </a></td>
                                            <td>Wong Chu</td>
                                            <td>6/05/2018</td>
                                            <td class="text-center">UPS</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>dolor sit amet</td>
                                            <td><a href="#"
                                                    class="btn waves-effect waves-light btn-rounded open-bt">Delivered</a>
                                            </td>
                                            <td>Tim Langvelt</td>
                                            <td>9/05/2018</td>
                                            <td class="text-center">UPS</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>dolor amet</td>
                                            <td><a href="#"
                                                    class="btn waves-effect waves-light btn-rounded pending-bt">Shipped</a>
                                            </td>
                                            <td>Mitchell Marks</td>
                                            <td>9/06/2018</td>
                                            <td class="text-center">UPS</td>
    ...
    <footer class="footer">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 text-right font-12">Designed & Developed by <a href="http://www.srgit.com/"
                    target="_blank" class="text-themecolor">SRGIT</a></div>
        </div>
    </footer>
    <!-- ============================================================== -->
    <!-- End footer -->
...
<!-- Mirrored from www.creativethemes.co.in/buy-creativetheme-html-template/organicfood-store/image-html/html/ecommerce/main/ecommerce-shipments.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Mar 2024 19:20:32 GMT -->
