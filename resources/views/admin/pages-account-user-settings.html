...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/pages-account-user-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:45 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="pages-account-user-settings.html"><span>Settings</span></a></li>
							...
							<div class="card shadow-card p6 mb6">
								...
								<form method="post" action="#" class="needs-validation" novalidate>
									<div class="row align-items-center mb5">
										...
										<div class="col-4">
											<input id="settings-form-1" class="form-control" type="text" autocomplete="off" value="Barry" required>
											<div class="invalid-feedback">You need to fill this field.</div>
										</div>
										<div class="col-4">
											<input class="form-control" type="text" autocomplete="off" value="Tone" required>
											<div class="invalid-feedback">You need to fill this field.</div>
										</div>
									</div>
									<div class="row align-items-center mb5">
										...
										<div class="col-8">
											<input id="settings-form-2" class="form-control" type="text" autocomplete="off" value="+1-202-555-0116" required>
											<div class="invalid-feedback">You need to fill this field.</div>
										</div>
									</div>
									<div class="row align-items-center mb5">
										...
										<div class="col-8">
											<input id="settings-form-3" class="form-control" type="text" autocomplete="off" value="Tempload Themes" required>
											<div class="invalid-feedback">You need to fill this field.</div>
										</div>
									</div>
									<div class="row align-items-center mb5">
										...
										<div class="col-8">
											<input id="settings-form-4" class="form-control" type="text" autocomplete="off" value="examplesite.com" required>
											<div class="invalid-feedback">You need to fill this field.</div>
										</div>
									</div>
									<div class="row align-items-center mb5">
										<div class="col-4">
											<label for="settings-form-5" class="form-label m0">
												<span>Country</span>
												<span class="text-danger">*</span>
												<i data-feather="info" stroke-width="2" height="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Choose a country from the list."></i>
											</label>
										</div>
										<div class="col-8">
										...
										<div class="col-8">
											<div class="row">
												<div class="col-xxl-2 col-lg-3 mobile-bottom-fix">
													<div class="d-flex align-items-center">
														<div class="checkbox checkbox-primary">
															<input type="checkbox" name="settings-check1" id="settings-check1" checked>
												...
												<div class="col-xxl-2 col-lg-3 mobile-bottom-fix">
													<div class="d-flex align-items-center">
														<div class="checkbox checkbox-primary">
															<input type="checkbox" name="settings-check2" id="settings-check2">
												...
												<div class="col-xxl-2 col-lg-3 mobile-bottom-fix">
													<div class="d-flex align-items-center">
														<div class="checkbox checkbox-primary">
															<input type="checkbox" name="settings-check3" id="settings-check3">
									...
									<div class="row">
										<div class="col-12">
											<div class="text-end">
												<button type="button" class="btn btn-secondary btn-soft me2">Discard</button>
									...
									<table class="table qd-table align-middle mb0">
										<tbody>
											<tr>
												...
												<td class="text-end">
													<button type="button" class="btn btn-secondary btn-soft">Change Email</button>
												</td>
											</tr>
											<tr>
												<td>
												...
												<td class="text-end">
													<button type="button" class="btn btn-secondary btn-soft">Reset Password</button>
												</td>
											</tr>
											<tr>
												<td>
											...
											<tr>
												<td>
													<div class="d-flex flex-row align-items-start">
														<strong class="text-heading me1">Billing Notifications</strong>
														<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Adjust settings for billing notifications."></i>
													</div>
												</td>
												<td class="text-center">
													<div class="checkbox checkbox-primary">
														<input type="checkbox" name="notification-check1" id="notification-check1" checked>
														<label for="notification-check1"></label>
													</div>
												</td>
												<td class="text-center">
													<div class="checkbox checkbox-primary">
														<input type="checkbox" name="notification-check2" id="notification-check2" checked>
														<label for="notification-check2"></label>
													</div>
												</td>
												<td class="text-center">
													<div class="checkbox checkbox-primary">
														<input type="checkbox" name="notification-check3" id="notification-check3" checked>
											...
											<tr>
												<td>
													<div class="d-flex flex-row align-items-start">
														...
														<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Adjust settings for newsletter notifications."></i>
													</div>
												</td>
												<td class="text-center">
													<div class="checkbox checkbox-primary">
														<input type="checkbox" name="notification-check4" id="notification-check4" checked>
														<label for="notification-check4"></label>
													</div>
												</td>
												<td class="text-center">
													<div class="checkbox checkbox-primary">
														<input type="checkbox" name="notification-check5" id="notification-check5">
														<label for="notification-check5"></label>
													</div>
												</td>
												<td class="text-center">
													<div class="checkbox checkbox-primary">
														<input type="checkbox" name="notification-check6" id="notification-check6">
											...
											<tr>
												<td>
													<div class="d-flex flex-row align-items-start">
														...
														<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Adjust settings for new user notifications."></i>
													</div>
												</td>
												<td class="text-center">
													<div class="checkbox checkbox-primary">
														<input type="checkbox" name="notification-check7" id="notification-check7">
														<label for="notification-check7"></label>
													</div>
												</td>
												<td class="text-center">
													<div class="checkbox checkbox-primary">
														<input type="checkbox" name="notification-check8" id="notification-check8" checked>
														<label for="notification-check8"></label>
													</div>
												</td>
												<td class="text-center">
													<div class="checkbox checkbox-primary">
														<input type="checkbox" name="notification-check9" id="notification-check9">
											...
											<tr>
												<td>
													<div class="d-flex flex-row align-items-start">
														...
														<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Adjust settings for in-app messaging notifications."></i>
													</div>
												</td>
												<td class="text-center">
													<div class="checkbox checkbox-primary">
														<input type="checkbox" name="notification-check10" id="notification-check10">
														<label for="notification-check10"></label>
													</div>
												</td>
												<td class="text-center">
													<div class="checkbox checkbox-primary">
														<input type="checkbox" name="notification-check11" id="notification-check11">
														<label for="notification-check11"></label>
													</div>
												</td>
												<td class="text-center">
													<div class="checkbox checkbox-primary">
														<input type="checkbox" name="notification-check12" id="notification-check12">
											...
											<tr>
												<td>
													<div class="d-flex flex-row align-items-start">
														...
														<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Adjust settings for server uptime notifications."></i>
													</div>
												</td>
												<td class="text-center">
													<div class="checkbox checkbox-primary">
														<input type="checkbox" name="notification-check1" id="notification-check13" checked>
														<label for="notification-check13"></label>
													</div>
												</td>
												<td class="text-center">
													<div class="checkbox checkbox-primary">
														<input type="checkbox" name="notification-check14" id="notification-check14">
														<label for="notification-check14"></label>
													</div>
												</td>
												<td class="text-center">
													<div class="checkbox checkbox-primary">
														<input type="checkbox" name="notification-check15" id="notification-check15" checked>
...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/pages-account-user-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:46 GMT -->
</html>