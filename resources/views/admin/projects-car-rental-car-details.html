...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/projects-car-rental-car-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:44:05 GMT -->
<head>
	<meta charset="UTF-8">
						...
						<div class="container-fluid">
							...
							<div class="row">
								...
								<div class="col-sm-6 mb5">
									...
									<input id="add-car-form-7" class="form-control" type="text" value="KA PA 777" required>
										...
										<div class="row">
											<div class="col-lg-6 mb3">
												<label for="add-car-form-11" class="form-label">
													...
													<span class="text-danger">*</span>
													<i data-feather="info" stroke-width="2" height="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Select a date range for the rental season."></i>
												</label>
												<input id="add-car-form-11" class="form-control qd-datepicker" type="text" autocomplete="off" value="2023-04-01; 2023-06-30" required>
											...
											<div class="col-lg-6 mb3">
												<label for="add-car-form-12" class="form-label">
													<span>Price</span>
													<span class="text-danger">*</span>
													<i data-feather="info" stroke-width="2" height="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Daily price between the respective season dates."></i>
												</label>
												<div class="input-group">
													<input id="add-car-form-12" class="form-control" type="text" placeholder="10,00" value="15,00" required>
									...
									<div class="border border-dashed rounded p5 pb4">
										...
										<div class="row">
											<div class="col-lg-6 mb3">
												...
												<input id="add-car-form-13" class="form-control qd-datepicker" type="text" autocomplete="off" value="2023-07-01; 2023-10-30" required>
												<div class="invalid-feedback">Choose a date range.</div>
											</div>
											<div class="col-lg-6 mb3">
												...
												<div class="input-group">
													<input id="add-car-form-14" class="form-control" type="text" placeholder="10,00" value="12,00" required>
													<span class="input-group-text">USD</span>
													<div class="invalid-feedback">Enter a valid price.</div>
												</div>
											</div>
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="projects-car-rental-car-details.html"><span>Car Details</span></a></li>
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						...
						<div class="col-md-6 text-start text-md-end">
							<!-- Add Button Start-->
							<button class="btn btn-primary btn-soft" data-bs-toggle="modal" data-bs-target="#addCarModal">Edit Car</button>
							<!-- Add Button End-->
						</div>
					</div>
					<!-- Page Top End -->
								...
								<div class="col-lg-6 mb6">
									<div class="card shadow-card p2">
										<div class="row">
											<div class="col-12">
												<div class="position-relative">
													<div class="z-2 position-relative p5 d-flex flex-row align-items-center justify-content-center">
														<h6 class="m0 text-body">Total Earnings</h6>
													</div>
													<div class="position-absolute w-100 h-100 start-0 bottom-0 bg-light rounded-top z-1"></div>
												</div>
											</div>
										</div>
											...
											<table class="table qd-table align-middle">
												...
												<tbody>
													<tr>
														...
														<td class="text-end">
															<span class="badge rounded-pill badge-soft text-bg-primary">$10,00</span>
														</td>
													</tr>
													<tr>
														<td>
														...
														<td class="text-end">
															<span class="badge rounded-pill badge-soft text-bg-primary">$12,00</span>
														</td>
													</tr>
													<tr>
														<td>
														...
														<td class="text-end">
															<span class="badge rounded-pill badge-soft text-bg-primary">$15,00</span>
														</td>
													</tr>
													<tr>
														<td>
														...
														<td class="text-end">
															<span class="badge rounded-pill badge-soft text-bg-primary">$8,00</span>
														</td>
													</tr>
												</tbody>
											</table>
