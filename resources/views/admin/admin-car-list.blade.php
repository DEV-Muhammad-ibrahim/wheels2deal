            ...
            <div class="sidebar-menu custom-scroll pt-4">
                ...
                <ul class="menu-group m-0 px-4 mb-4">
                    <li class="sub-menu active">
                        ...
                        <ul class="sub-menu-group">
                            <li class="active"><a href="projects-car-rental-car-list.html"><span>Car List</span></a>
                            </li>
                                                        ...
                                                        <div class="col-sm-3 mb-sm-1">
                                                            ...
                                                            <ul class="mega-sub-menu">
                                                                ...
                                                                <li><a class="hover-primary"
                                                                        ...
                                                                        List</a></li>
                                                                <li><a class="hover-primary"
                                                                        href="projects-blog-add-blog.html">Add
                                                                        Blog</a></li>
                                                                <li><a class="hover-primary"
                    ...
                    <div class="row mb6 align-items-center">
                        ...
                        <div class="col-md-6 text-start text-md-end">
                            ...
                            <button class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#addCarModal">Add Car</button>
                            <!-- Add Button End-->
                        </div>
                    </div>
                    <!-- Page Top End -->
