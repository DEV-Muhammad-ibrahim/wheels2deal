...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/projects-ecommerce-order-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:46:16 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="projects-ecommerce-order-list.html"><span>Order List</span></a></li>
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-md-6 mobile-bottom-fix">
							<h1 class="page-title mb2">Order List</h1>
							...
							<div class="dropdown d-inline me4">
								...
								<div class="dropdown-menu width-310 p0">
									...
									<div class="p5 px-4">
										<div class="row mb5">
											<div class="col-12">
												<label for="form-element-2" class="form-label">Payment Status:</label>
									...
									<div class="p6">
										<div class="row align-items-center">
											...
											<div class="col-md-9 text-end d-flex justify-content-end">
												<input class="form-control width-220 qd-datepicker me3" type="text" placeholder="Pick Date Range">
												<div class="dropdown">
													<button type="button" class="bg-transparent p0 outline-none dropdown-toggle arrow-none border height-40 rounded ps3" data-bs-toggle="dropdown" aria-expanded="false">
											...
											<tbody>
												<tr>
													...
													<td>
														...
														<a href="#" class="text-decoration-none text-body hover-primary">justin@example.com</a>
													</td>
													<td>
													...
													<td>
														<span class="badge rounded-pill badge-soft text-bg-warning">Processing</span>
													</td>
													<td>
												...
												<tr>
													...
													<td>
														...
														<a href="#" class="text-decoration-none text-body hover-primary">elon@example.com</a>
													</td>
													<td>
														<strong class="text-heading d-block mb1">09 Apr, 2023</strong>
														<small>10:28PM</small>
												...
												<tr>
													...
													<td>
														<strong class="text-heading d-block mb1">Natalya Undergrowth</strong>
														<a href="#" class="text-decoration-none text-body hover-primary">natalya@example.com</a>
													</td>
													<td>
												...
												<tr>
													...
													<td>
														<strong class="text-heading d-block mb1">Lurch Schpellchek</strong>
														<a href="#" class="text-decoration-none text-body hover-primary">lurch@example.com</a>
													</td>
													<td>
														<strong class="text-heading d-block mb1">08 Apr, 2023</strong>
														<small>09:38PM</small>
													...
													<td>
														<span class="badge rounded-pill badge-soft text-bg-danger">Payment Failed</span>
													</td>
													<td>
												...
												<tr>
													...
													<td>
														<strong class="text-heading d-block mb1">Rodney Artichoke</strong>
												...
												<tr>
													...
													<td>
														<strong class="text-heading d-block mb1">Desmond Eagle</strong>
														<a href="#" class="text-decoration-none text-body hover-primary">desmond@example.com</a>
													</td>
													<td>
												...
												<tr>
													...
													<td>
														<strong class="text-heading d-block mb1">Indigo Violet</strong>
												...
												<tr>
													...
													<td>
														<strong class="text-heading d-block mb1">Russell Sprout</strong>
														<a href="#" class="text-decoration-none text-body hover-primary">russel@example.com</a>
													</td>
													<td>
														<strong class="text-heading d-block mb1">07 Apr, 2023</strong>
														<small>06:25AM</small>
													...
													<td>
														<span class="badge rounded-pill badge-soft text-bg-danger">Cancelled</span>
													</td>
													<td>
														<div class="dropdown text-end">
															<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												...
												<tr>
													...
													<td>
														<strong class="text-heading d-block mb1">Dominic L. Ement</strong>
														<a href="#" class="text-decoration-none text-body hover-primary">dominic@example.com</a>
													</td>
													<td>
													...
													<td>
														<span class="badge rounded-pill badge-soft text-bg-warning">Awaiting Authorization</span>
													</td>
													<td>
												...
												<tr>
													...
													<td>
														...
														<a href="#" class="text-decoration-none text-body hover-primary">barry@example.com</a>
													</td>
													<td>
														<strong class="text-heading d-block mb1">06 Apr, 2023</strong>
														<small>08:16AM</small>
												...
												<tr>
													...
													<td>
														<strong class="text-heading d-block mb1">Jason Response</strong>
														<a href="#" class="text-decoration-none text-body hover-primary">jason@example.com</a>
													</td>
													<td>
														<strong class="text-heading d-block mb1">06 Apr, 2023</strong>
														<small>07:22AM</small>
													...
													<td>
														<span class="badge rounded-pill badge-soft text-bg-success">Delivered</span>
													</td>
													<td>
														<div class="dropdown text-end">
															<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												...
												<tr>
													...
													<td>
														<strong class="text-heading d-block mb1">Dylan Meringue</strong>
														<a href="#" class="text-decoration-none text-body hover-primary">dylan@example.com</a>
													</td>
													<td>
												...
												<tr>
													...
													<td>
														<strong class="text-heading d-block mb1">Parsley Montana</strong>
														<a href="#" class="text-decoration-none text-body hover-primary">parsley@example.com</a>
													</td>
													<td>
														<strong class="text-heading d-block mb1">05 Apr, 2023</strong>
														<small>09:38AM</small>
