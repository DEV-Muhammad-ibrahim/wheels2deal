...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/pages-account-user-overview.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:12 GMT -->
<head>
	<meta charset="UTF-8">
			...
			<div class="sidebar-menu custom-scroll pt-4">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							<li class="active"><a href="pages-account-user-overview.html"><span>Overview</span></a></li>
					...
					<div class="row">
						...
						<div class="col-xxl-4">
													...
													<tr>
														...
														<td>
															<div class="d-flex align-items-center justify-content-start">
																<strong class="text-heading me3">+1-202-555-0116</strong>
																<span class="badge rounded-pill badge-soft text-bg-success">Verified</span>
															</div>
														</td>
													</tr>
													<tr>
														...
														<td>
															<div class="d-flex align-items-center justify-content-start">
																<strong class="me3"><a href="#" class="text-decoration-none text-heading hover-primary">barry@domain.com</a></strong>
																<span class="badge rounded-pill badge-soft text-bg-danger">Not Verified</span>
															</div>
														</td>
													</tr>
													<tr>
														...
														<td>
															<strong class="text-heading">Florida, United States</strong>
														</td>
													</tr>
													<tr>
														<td>
														...
														<td>
															<strong><a href="#" class="text-decoration-none text-heading hover-primary">examplesite.com</a></strong>
														</td>
													</tr>
													<tr>
														<td>
							...
							<div class="card shadow-card p6 mb6">
								...
								<div class="row">
									<div class="col-12">
										<a href="#"><span class="badge badge-soft text-bg-primary me3 mb2">HTML5</span></a>
										<a href="#"><span class="badge badge-soft text-bg-primary me3 mb2">React</span></a>
										<a href="#"><span class="badge badge-soft text-bg-primary me3 mb2">Vue.js</span></a>
										<a href="#"><span class="badge badge-soft text-bg-primary me3 mb2">React Native</span></a>
										<a href="#"><span class="badge badge-soft text-bg-primary me3 mb2">GO Lang</span></a>
										<a href="#"><span class="badge badge-soft text-bg-primary me3 mb2">OOP Programming</span></a>
										<a href="#"><span class="badge badge-soft text-bg-primary me3 mb2">UI/UX Design</span></a>
										<a href="#"><span class="badge badge-soft text-bg-primary me3 mb2">Basic SEO</span></a>
										<a href="#"><span class="badge badge-soft text-bg-primary me3 mb2">Responsive Design</span></a>
									</div>
								</div>	
							</div>
							<!-- Skills Card End -->
								...
								<div class="row">
									<div class="col-12 mb3">
										<div class="d-flex flex-column">
											...
											<p>Barry Tone is an exceptional computer programmer with a passion for creating innovative solutions to complex problems. His expertise in programming languages such as Python, Java, and C++ is matched by his ability to think creatively and outside the box. Barry's attention to detail and love of debugging makes him an invaluable member of any team, and his ability to work efficiently under pressure has made him a sought-after asset in the industry.</p>
											<p>In his free time, Barry can often be found tinkering with new technologies, experimenting with different programming languages, and attending tech conferences to stay up-to-date with the latest industry trends. His drive for excellence and his commitment to his work make him a standout in the field of computer programming, and we can't wait to see what innovative solutions he creates in the future.</p>
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-sm-3 col-6 mb6">
										<a href="assets/media/man/1.jpg" class="d-block height-130 img-fix rounded" data-fslightbox="gallery">
											<img src="assets/media/man/1.jpg" alt="">
										</a>
									</div>
									<div class="col-sm-3 col-6 mb6">
										<a href="assets/media/man/2.jpg" class="d-block height-130 img-fix rounded" data-fslightbox="gallery">
											<img src="assets/media/man/2.jpg" alt="">
										</a>
									</div>
									<div class="col-sm-3 col-6 mb6">
										<a href="assets/media/man/3.jpg" class="d-block height-130 img-fix rounded" data-fslightbox="gallery">
											<img src="assets/media/man/3.jpg" alt="">
										</a>
									</div>
									<div class="col-sm-3 col-6 mb6">
										<a href="assets/media/man/4.jpg" class="d-block height-130 img-fix rounded" data-fslightbox="gallery">
										...
										<div class="border border-dashed rounded overflow-hidden">
											<div class="row">
												<div class="col-xxl-3 mb-4 mb-xxl-0">
													<div class="bg-light p4 d-flex align-items-center justify-content-center">
														<div class="d-flex">
											...
											<div class="row">
												...
												<div class="col-xxl-3 mb-4 mb-xxl-0 d-flex align-items-center justify-content-center">
													<div class="d-flex flex-column">
														...
														<div class="progress width-200 height-5" role="progressbar" aria-label="Basic example" aria-valuenow="28" aria-valuemin="0" aria-valuemax="100">
...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/pages-account-user-overview.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:45 GMT -->
</html>