...
<!-- Mirrored from www.creativethemes.co.in/buy-creativetheme-html-template/organicfood-store/image-html/html/ecommerce/main/ecommerce-products-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Mar 2024 19:20:15 GMT -->
<head>
<meta charset="utf-8">
    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-light"> 
      ...
      <div class="navbar-collapse"> 
        ...
        <ul class="navbar-nav my-lg-0">
          ...
          <!-- Profile --> 
          <!-- ============================================================== -->
          <li class="nav-item dropdown u-pro"> <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="../assets/images/users/1.jpg" alt="user"> <span class="hidden-md-down">Hi, Dave Wiesley &nbsp;<i class="fa fa-angle-down"></i></span> </a>
...
<div class="page-wrapper"> 
  ...
  <div class="container-fluid"> 
    ...
    <div class="row page-titles">
      ...
      <div class="col-6 text-right font-12"> <a href="index.html">Admin</a> &gt;  Products Details</div>
      <div class="">
    ...
    <div class="row">
        ...
        <div class="card">
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-5">
                <h4 class="font-26 text-blue mb-20 font-medium product-details">Product Details</h4>
                <p class="font-16 font-light">Free Shipping</p>
                <h4 class="font-26 mb-20 font-medium text-gray">$ 1999.00</h4>
                <hr class="mt-30 mb-30">
                <div class="row">
                  <div class="col-md-5 mb-5 font-medium">Manufacturer</div>
                  <div class="col-md-7 mb-5 ">Brand name</div>
                  <div class="col-md-5 mb-5 font-medium">Material </div>
                  <div class="col-md-7 mb-5">Wooden</div>
                  <div class="col-md-5 mb-5 font-medium">Availability</div>
                  <div class="col-md-7 mb-5">
                    <div class="custom-control custom-checkbox">
                      <input type="checkbox" class="custom-control-input" id="defaultUnchecked">
                      <label class="custom-control-label" for="defaultUnchecked">In Stock</label>
                    </div>
                  </div>
                </div>
                <hr class="mt-30 mb-30">
                ...
                <a href="#" class="btn btn-dark"> Edit Product </a> </div>
            </div>
          </div>
        </div>
        <div class="clearfix"></div>
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-body">
            <h3 class="font-bold text-gray">Description</h3>
            <p> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy  quia dolor sit amet, consectLorem Ipsum is simply dummy text of the  rinting and typesetting industry. Lorem Ipsum has been the industry's standard dummy  quia dolor sit amet, consectLorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum  as been the industry's standard dummy  quia dolor sit amet, consect </p>
          </div>
        </div>
      </div>
    </div>
...
<script src="../assets/vendors/icheck/icheck.init.js"></script> 
<!-- ============================================================== --> 
<!-- Style switcher --> 
<!-- ============================================================== --> 
...
<!-- Mirrored from www.creativethemes.co.in/buy-creativetheme-html-template/organicfood-store/image-html/html/ecommerce/main/ecommerce-products-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Mar 2024 19:20:25 GMT -->
</html>