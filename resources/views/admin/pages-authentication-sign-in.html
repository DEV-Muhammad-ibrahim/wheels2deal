...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/pages-authentication-sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:50 GMT -->
<head>
	<meta charset="UTF-8">
			...
			<div class="col-lg-6 overflow-hidden">
				<div class="vh-100 bg-primary">
					<div class="p7 pb6">
						...
						<p class="text-white-50">Qoduby is a management and data visualization software for medium <br>to high volume projects.</p>
					</div>
					<div class="ps7 h-100">
						...
						<div class="d-flex flex-column align-items-center justify-content-center">
							...
							<form action="#" class="needs-validation mb7" novalidate>
								<div class="row">
									...
									<div class="col-12 mb4">
										<input class="form-control form-control-lg w-100" type="password" placeholder="Password">
									</div>
...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/pages-authentication-sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:52 GMT -->
</html>