...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/projects-car-rental-car-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:44:05 GMT -->
<head>
	<meta charset="UTF-8">
									...
									<div class="border border-dashed rounded p5 pb4">
										...
										<div class="row">
											<div class="col-lg-6 mb3">
												...
												<input id="add-car-form-11" class="form-control qd-datepicker" type="text" autocomplete="off" required>
											...
											<div class="col-lg-6 mb3">
												...
												<div class="input-group">
													<input id="add-car-form-12" class="form-control" type="text" placeholder="10,00" required>
									...
									<div class="border border-dashed rounded p5 pb4">
										...
										<div class="row">
											<div class="col-lg-6 mb3">
												...
												<input id="add-car-form-13" class="form-control qd-datepicker" type="text" autocomplete="off" required>
												<div class="invalid-feedback">Choose a date range.</div>
											</div>
											<div class="col-lg-6 mb3">
												...
												<div class="input-group">
													<input id="add-car-form-14" class="form-control" type="text" placeholder="10,00" required>
													<span class="input-group-text">USD</span>
													<div class="invalid-feedback">Enter a valid price.</div>
												</div>
											</div>
			...
			<div class="sidebar-menu custom-scroll pt-4">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							<li class="active"><a href="projects-car-rental-car-list.html"><span>Car List</span></a></li>
