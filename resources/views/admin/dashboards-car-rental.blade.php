...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/dashboards-car-rental.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:41:55 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
				...
				<ul class="menu-group m-0 px-4 mb-4">
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="dashboards-car-rental.html"><span>Car Rental</span></a></li>
						</ul>
					</li>
				</ul>
				<!-- ***** Dashboards Menu End ***** -->
					...
					<div class="row">
						...
						<div class="col-xxl-3 mb5">
							<div class="card shadow-card p6">
								...
								<div class="row">
									<div class="col-12">
										<div class="d-flex justify-content-start text-decoration-none border-bottom-dashed pb4 mb4">
											<div class="me3">
												<div class="rounded-circle bg-primary-subtle width-40 height-40 d-flex align-items-center justify-content-center">
													<i data-feather="map-pin" stroke-width="2" height="22" class="text-primary"></i>
												</div>
											</div>
											<div class="d-flex flex-column align-items-start">
												<strong class="text-heading me1">Arrived Customer</strong>
												<span class="mb1 text-body">#348 has been arrived</span>
												<span class="badge rounded-pill badge-soft text-bg-primary">3 minutes ago</span>
											</div>
										</div>
										<div class="d-flex justify-content-start text-decoration-none border-bottom-dashed pb4 mb4">
											<div class="me3">
												<div class="rounded-circle bg-info-subtle width-40 height-40 d-flex align-items-center justify-content-center">
													<i data-feather="file-text" stroke-width="2" height="22" class="text-info"></i>
												</div>
											</div>
											<div class="d-flex flex-column align-items-start">
												<strong class="text-heading me1">Arrived New Car</strong>
												<span class="mb1 text-body">Car #27 has been arrived</span>
												<span class="badge rounded-pill badge-soft text-bg-info">7 minutes ago</span>
											</div>
										</div>
										<div class="d-flex justify-content-start text-decoration-none">
											<div class="me3">
												<div class="rounded-circle bg-success-subtle width-40 height-40 d-flex align-items-center justify-content-center">
													<i data-feather="dollar-sign" stroke-width="2" height="22" class="text-success"></i>
												</div>
											</div>
											<div class="d-flex flex-column align-items-start">
												<strong class="text-heading me1">Arrived Passenger</strong>
												<span class="mb1 text-body">Customer #16 has been</span>
												<span class="badge rounded-pill badge-soft text-bg-success">12 minutes ago</span>
											</div>
										</div>
									</div>
								</div>
											...
											<table class="table qd-table mb0 align-middle">
												<tbody>
													<tr>
														...
														<td>
															<span class="badge badge-soft text-bg-success">Active</span>
														</td>
													</tr>
													<tr>
														<td>
									...
									<div class="col d-flex flex-row justify-content-end">
										<div class="dropdown">
											...
											<ul class="dropdown-menu text-start">
												...
												<li><a class="dropdown-item" href="#">Last 9 Month</a></li>
												<li><a class="dropdown-item" href="#">Last 12 Month</a></li>
												<li>
													<a class="dropdown-item d-flex align-items-center justify-content-between" href="#">
														Current Year <i data-feather="info" stroke-width="2" height="12" class="text-body me1" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-custom-class="qd-tooltip" data-bs-title="Only data from the beginning of the year to this time are shown."></i>
													</a>
										...
										<div class="row">
											<div class="overflow-x-scroll">
												<div class="col-12 mb5">
													...
													<div class="d-flex">
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">01</div>
														<div class="bg-warning-subtle text-warning p3 px-3 rounded me1">02</div>
														<div class="bg-warning-subtle text-warning p3 px-3 rounded me1">03</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">04</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">05</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">06</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">07</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">08</div>
														<div class="bg-success-subtle text-success p3 px-3 rounded me1">09</div>
														<div class="bg-success-subtle text-success p3 px-3 rounded me1">10</div>
														<div class="bg-success-subtle text-success p3 px-3 rounded me1">11</div>
														<div class="bg-success-subtle text-success p3 px-3 rounded me1">12</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">13</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">14</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">15</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">16</div>
														<div class="bg-primary-subtle text-primary p3 px-3 rounded me1">17</div>
														<div class="bg-primary-subtle text-primary p3 px-3 rounded me1">18</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">19</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">20</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">21</div>
														<div class="bg-success-subtle text-success p3 px-3 rounded me1">22</div>
														<div class="bg-success-subtle text-success p3 px-3 rounded me1">23</div>
														<div class="bg-success-subtle text-success p3 px-3 rounded me1">24</div>
														<div class="bg-success-subtle text-success p3 px-3 rounded me1">25</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">26</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">27</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">28</div>
														<div class="bg-danger-subtle text-danger p3 px-3 rounded me1">29</div>
														<div class="bg-danger-subtle text-danger p3 px-3 rounded me1">30</div>
													</div>
												</div>
												<div class="col-12 mb5">
													...
													<div class="d-flex">
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">01</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">02</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">03</div>
														<div class="bg-success-subtle text-success p3 px-3 rounded me1">04</div>
														<div class="bg-success-subtle text-success p3 px-3 rounded me1">05</div>
														<div class="bg-success-subtle text-success p3 px-3 rounded me1">06</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">07</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">08</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">09</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">10</div>
														<div class="bg-warning-subtle text-warning p3 px-3 rounded me1">11</div>
														<div class="bg-warning-subtle text-warning p3 px-3 rounded me1">12</div>
														<div class="bg-warning-subtle text-warning p3 px-3 rounded me1">13</div>
														<div class="bg-warning-subtle text-warning p3 px-3 rounded me1">14</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">15</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">16</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">17</div>
														<div class="bg-success-subtle text-success p3 px-3 rounded me1">18</div>
														<div class="bg-success-subtle text-success p3 px-3 rounded me1">19</div>
														<div class="bg-success-subtle text-success p3 px-3 rounded me1">20</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">21</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">22</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">23</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">24</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">25</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">26</div>
														<div class="bg-success-subtle text-success p3 px-3 rounded me1">27</div>
														<div class="bg-success-subtle text-success p3 px-3 rounded me1">28</div>
														<div class="bg-success-subtle text-success p3 px-3 rounded me1">29</div>
														<div class="bg-success-subtle text-success p3 px-3 rounded me1">30</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">31</div>
													</div>
												</div>
												<div class="col-12">
													<strong class="d-block mb2">June 2023</strong>
													<div class="d-flex">
														<div class="bg-success-subtle text-success p3 px-3 rounded me1">01</div>
														<div class="bg-success-subtle text-success p3 px-3 rounded me1">02</div>
														<div class="bg-success-subtle text-success p3 px-3 rounded me1">03</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">04</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">05</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">06</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">07</div>
														...
														<div class="bg-success-subtle text-success p3 px-3 rounded me1">11</div>
														<div class="bg-success-subtle text-success p3 px-3 rounded me1">12</div>
														<div class="bg-success-subtle text-success p3 px-3 rounded me1">13</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">14</div>
														<div class="bg-secondary-subtle text-heading p3 px-3 rounded me1">15</div>
														<div class="bg-danger-subtle text-danger p3 px-3 rounded me1">16</div>
														<div class="bg-danger-subtle text-danger p3 px-3 rounded me1">17</div>
														<div class="bg-danger-subtle text-danger p3 px-3 rounded me1">18</div>
														<div class="bg-light text-heading p3 px-3 rounded me1">19</div>
														<div class="bg-primary-subtle text-primary p3 px-3 rounded me1">20</div>
														<div class="bg-primary-subtle text-primary p3 px-3 rounded me1">21</div>
														<div class="bg-primary-subtle text-primary p3 px-3 rounded me1">22</div>
														<div class="bg-light text-heading p3 px-3 rounded me1">23</div>
														<div class="bg-light text-heading p3 px-3 rounded me1">24</div>
														<div class="bg-light text-heading p3 px-3 rounded me1">25</div>
														<div class="bg-light text-heading p3 px-3 rounded me1">26</div>
														<div class="bg-light text-heading p3 px-3 rounded me1">27</div>
														<div class="bg-success-subtle text-success p3 px-3 rounded me1">28</div>
														<div class="bg-success-subtle text-success p3 px-3 rounded me1">29</div>
														<div class="bg-success-subtle text-success p3 px-3 rounded me1">30</div>
													</div>
	...
	<script src="assets/js/pages/dashboards/dashboard-06.js" crossorigin="anonymous"></script>
</body>

<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/dashboards-car-rental.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:42:46 GMT -->
</html>