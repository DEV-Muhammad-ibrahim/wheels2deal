...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-chat-single-chat.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:12 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
			...
			<div class="sidebar-menu custom-scroll pt-4">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							<li class="active"><a href="apps-chat-single-chat.html"><span>Single Chat</span></a></li>
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						...
						<div class="col-md-6 text-start text-md-end">
							<!-- Add Button Start-->
							<button class="btn btn-primary"  data-bs-toggle="modal" data-bs-target="#addModal">Add Contact</button>
							<!-- Add Button End-->
						</div>
					</div>
					<!-- Page Top End -->
	...
	<script src="assets/js/pages/apps/chat/single-chat.js" crossorigin="anonymous"></script>
</body>

<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-chat-single-chat.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:13 GMT -->
</html>