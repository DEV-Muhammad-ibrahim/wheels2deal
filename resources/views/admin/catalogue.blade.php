...
<!-- Mirrored from www.creativethemes.co.in/buy-creativetheme-html-template/organicfood-store/image-html/html/ecommerce/main/ecommerce-products-catalogue.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Mar 2024 19:20:10 GMT -->
<head>
<meta charset="utf-8">
...
<!-- Favicon icon -->
<link rel="shortcut icon" type="image/x-icon" href="https://www.creativethemes.co.in/buy-creativetheme-html-template/organicfood-store/image-html/html/ecommerce/assets/images/favicon.ico">
...
<div id="main-wrapper"> 
  ...
  <header class="topbar">
    <nav class="navbar top-navbar navbar-expand-md navbar-light"> 
      ...
      <!-- Logo --> 
      <!-- ============================================================== -->
      <div class="navbar-header"> <a class="navbar-brand" href="ecommerce-dashboard.html"> 
        <!-- Logo icon --> 
        <b> 
      ...
      <div class="navbar-collapse"> 
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <!-- ============================================================== -->
          <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle waves-effect waves-dark" href="#" id="2" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="icon-Mail"></i>
            <div class="notify"> <span class="heartbit"></span> <span class="point"></span> </div>
            </a>
            <div class="dropdown-menu mailbox dropdown-menu-end animated fadeIn" aria-labelledby="2">
              <ul>
                <li>
          ...
          <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle waves-effect waves-dark" href="#" id="3" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="icon-Support"></i>
            <div class="notify"> <span class="heartbit"></span> <span class="point"></span> </div>
            </a>
            <div class="dropdown-menu mailbox dropdown-menu-end animated fadeIn" aria-labelledby="3">
              <ul>
                <li>
          ...
          <li class="nav-item dropdown"> <a  href="#"  class="nav-link dropdown-toggle waves-effect waves-dark font-weight-light" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="icon-Information"></i> </a> </li>
          <li>
            <div class="time-date"><i class="fa fa-calendar-o"></i> &nbsp; Sat, 17  jan 2022 <img src="../assets/images/sep.png" alt=""> <i class="fa fa-clock-o"></i> &nbsp;  10 : 33 : 22 AM</div>
          </li>
        </ul>
        <!-- ============================================================== --> 
        ...
        <ul class="navbar-nav my-lg-0">
          ...
          <!-- Profile --> 
          <!-- ============================================================== -->
          <li class="nav-item dropdown u-pro"> <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="../assets/images/users/1.jpg" alt="user" class=""> <span class="hidden-md-down">Hi, Dave Wiesley &nbsp;<i class="fa fa-angle-down"></i></span> </a>
...
<li> <a class="waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-cart-outline mr-10"></i><span class="hide-menu">Ecommerce Admin</span></a></li>
   
         
<li> <a class="waves-effect waves-dark" href="ecommerce-dashboard.html">

<i class="ti-angle-right"></i> <span class="hide-menu">Dashboard</span></a></li>
...
<a href="index.html">Admin</a>  &gt; Product Catalog</div>
      </div>
...
<div class="btn btn-rounded sale-btn mb-20 font-13">Sale</div>
<h4 class="mb-20">Product Name</h4>
<p class="mb-40">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
<div class="btn btn-rounded catalogue-btn mb-20 font-13">Remove from Products</div>
</div>
<div class="col-md-6 text-center"><img src="../assets/images/product/cat1.jpg" class="img-fluid" alt=""></div>
</div>
</div>
</div>
</div>
...
<div class="btn btn-rounded new-btn mb-20 font-13">New</div>
<h4 class="mb-20">Product Name</h4>
<p class="mb-40">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
<div class="btn btn-rounded catalogue-btn mb-20 font-13 catalogue-btn">Remove from Products</div>
</div>
<div class="col-md-6 text-center"><img src="../assets/images/product/cat2.jpg" class="img-fluid" alt=""></div>
</div> 
          </div>
          </div>
        </div>
...
<div class="card-body text-center">
 <img src="../assets/images/product/cat3.jpg" class="img-fluid" alt="">
<h4 class="mb-20 mt-20">Product Name</h4>
...
<div class="card">
<div class="card-body text-center">
 <img src="../assets/images/product/cat4.jpg" class="img-fluid" alt="">
<h4 class="mb-20 mt-20">Product Name</h4>
<p class="mb-10">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
<div class="btn btn-rounded catalogue-btn mb-20 font-13">Remove from Products</div>
</div>
...
<div class="card">
<div class="card-body text-center">
 <img src="../assets/images/product/cat5.jpg" class="img-fluid" alt="">
<h4 class="mb-20 mt-20">Product Name</h4>
<p class="mb-10">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
<div class="btn btn-rounded catalogue-btn mb-20 font-13">Remove from Products</div>
</div>
...
<div class="card">
<div class="card-body text-center">
 <img src="../assets/images/product/cat6.jpg" class="img-fluid" alt="">
<h4 class="mb-20 mt-20">Product Name</h4>
<p class="mb-10">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
<div class="btn btn-rounded catalogue-btn mb-20 font-13">Remove from Products</div>
</div>
...
<div class="card">
<div class="card-body text-center">
 <img src="../assets/images/product/cat7.jpg" class="img-fluid" alt="">
<h4 class="mb-20 mt-20">Product Name</h4>
<p class="mb-10">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
<div class="btn btn-rounded mb-20 font-13 catalogue-btn">Remove from Products</div>
</div>
</div>
</div>
...
<div class="card">
<div class="card-body text-center">
 <img src="../assets/images/product/cat8.jpg" class="img-fluid" alt="">
<h4 class="mb-20 mt-20">Product Name</h4>
<p class="mb-10">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
<div class="btn btn-rounded  mb-20 font-13 catalogue-btn">Remove from Products</div>
</div>
...
<div class="card">
<div class="card-body text-center">
 <img src="../assets/images/product/cat9.jpg" class="img-fluid" alt="">
<h4 class="mb-20 mt-20">Product Name</h4>
<p class="mb-10">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
<div class="btn btn-rounded catalogue-btn mb-20 font-13">Remove from Products</div>
</div>
...
<div class="card">
<div class="card-body text-center">
 <img src="../assets/images/product/cat10.jpg" class="img-fluid" alt="">
<h4 class="mb-20 mt-20">Product Name</h4>
<p class="mb-10">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
<div class="btn btn-rounded catalogue-btn mb-20 font-13">Remove from Products</div>
</div>
...
<footer class="footer">
<div class="row">
<div class="col-md-6 col-sm-6 font-12">Copyrights 2023. Organic E-store Admin. All Rights Reserved</div>
...
<!-- Mirrored from www.creativethemes.co.in/buy-creativetheme-html-template/organicfood-store/image-html/html/ecommerce/main/ecommerce-products-catalogue.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Mar 2024 19:20:14 GMT -->
</html>